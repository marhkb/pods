...
fn init() {
    ...
    view::ContainerCopyFromActionView::static_type();
    view::ContainerCopyFromOptsDialog::static_type();
    ...
    view::ImageBuildActionView::static_type();
    view::ImageBuildOptsDialog::static_type();
    ...
    view::VolumeCreateActionView::static_type();
    view::VolumeCreateOptsDialog::static_type();
