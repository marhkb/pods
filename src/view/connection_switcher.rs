...
mod imp {
    ...
    impl ObjectSubclass for ConnectionSwitcher {
        const NAME: &'static str = "PdsConnectionSwitcher";
        type Type = super::ConnectionSwitcher;
...
glib::wrapper! {
    pub(crate) struct ConnectionSwitcher(ObjectSubclass<imp::ConnectionSwitcher>)
        @extends gtk::Widget,
        @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
}

impl Default for ConnectionSwitcher {
    fn default() -> Self {
