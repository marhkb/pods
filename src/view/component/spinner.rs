...
mod imp {
    ...
    pub(crate) struct Spinner {
        ...
        pub(super) prev_animation_value: Cell<f32>,
    ...
    impl ObjectImpl for Spinner {
        ...
        fn property(&self, _id: usize, pspec: &glib::ParamSpec) -> glib::Value {
            ...
            match pspec.name() {
                ...
                "spinning" => obj.spinning().to_value(),
                _ => unimplemented!(),
            }
        }
        fn constructed(&self) {
    ...
    impl WidgetImpl for Spinner {
        ...
        fn snapshot(&self, snapshot: &gtk::Snapshot) {
            ...
            child_snapshot.append_conic_gradient(
                ...
                if animation_value - self.prev_animation_value.get() >= 0.0 {
                    animation_value * 180.0
                } else {
                    ((2.0 - animation_value) * 180.0)
                    //Calculate out the expanding progress
                    + ((1.0 - animation_value) * 360.0)
                } + 180.0,
                &[
                    gsk::ColorStop::new(animation_value, style_context.color()),
                    gsk::ColorStop::new(animation_value, gdk::RGBA::new(0.0, 0.0, 0.0, 0.0)),
                ],
            );
            child_snapshot.pop();
            ...
            self.prev_animation_value.set(animation_value);
        }

        fn map(&self) {
            self.parent_map();

            if self.obj().spinning() {
...
impl Spinner {
    ...
    pub(crate) fn set_spinning(&self, value: bool) {
        ...
        if value {
            ...
            imp.prev_animation_value.set(0.0);
        }
