...
mod imp {
    ...
    #[properties(wrapper_type = super::PruneUntilRow)]
    #[template(resource = "/com/github/marhkb/Pods/ui/component/prune-until-row.ui")]
    pub(crate) struct PruneUntilRow {
    ...
    impl ObjectSubclass for PruneUntilRow {
        const NAME: &'static str = "PdsPruneUntilRow";
        type Type = super::PruneUntilRow;
    ...
    impl ObjectImpl for PruneUntilRow {
    ...
    impl WidgetImpl for PruneUntilRow {}
    impl ListBoxRowImpl for PruneUntilRow {}
    impl PreferencesRowImpl for PruneUntilRow {}
    impl ExpanderRowImpl for PruneUntilRow {}
}

glib::wrapper! {
    pub(crate) struct PruneUntilRow(ObjectSubclass<imp::PruneUntilRow>)
