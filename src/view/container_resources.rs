...
mod imp {
    ...
    impl ObjectSubclass for ContainerResources {
        const NAME: &'static str = "PdsContainerResources";
        type Type = super::ContainerResources;
    ...
    impl ObjectImpl for ContainerResources {
    ...
    impl WidgetImpl for ContainerResources {}
    impl PreferencesGroupImpl for ContainerResources {}
}

glib::wrapper! {
    pub(crate) struct ContainerResources(ObjectSubclass<imp::ContainerResources>)
