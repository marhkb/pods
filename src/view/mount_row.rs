...
mod imp {
    ...
    impl ObjectSubclass for MountRow {
        const NAME: &'static str = "PdsMountRow";
        type Type = super::MountRow;
    ...
    impl WidgetImpl for MountRow {}
    impl ListBoxRowImpl for MountRow {}
    impl PreferencesRowImpl for MountRow {}
    impl ExpanderRowImpl for MountRow {}
...
glib::wrapper! {
    pub(crate) struct MountRow(ObjectSubclass<imp::MountRow>)
