...
mod imp {
    ...
    impl ObjectSubclass for ImageBuildPage {
        const NAME: &'static str = "ImageBuildPage";
        ...
        fn properties() -> &'static [glib::ParamSpec] {
            static PROPERTIES: Lazy<Vec<glib::ParamSpec>> = Lazy::new(|| {
                vec![glib::ParamSpecObject::new(
                    "client",
                    "Client",
                    "The client of this ImageBuildPage",
...
impl From<Option<&model::Client>> for ImageBuildPage {
    fn from(client: Option<&model::Client>) -> Self {
        glib::Object::new(&[("client", &client)]).expect("Failed to create ImageBuildPage")
    }
}
