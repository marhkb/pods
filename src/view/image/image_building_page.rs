...
mod imp {
    ...
    pub(crate) struct ImageBuildingPage {
    ...
    impl ObjectSubclass for ImageBuildingPage {
        const NAME: &'static str = "ImageBuildingPage";
        type Type = super::ImageBuildingPage;
    ...
    impl ObjectImpl for ImageBuildingPage {
        fn properties() -> &'static [glib::ParamSpec] {
            static PROPERTIES: Lazy<Vec<glib::ParamSpec>> = Lazy::new(|| {
                vec![glib::ParamSpecObject::new(
                    "client",
                    "Client",
                    "The client of this ImageBuildingPage",
    ...
    impl WidgetImpl for ImageBuildingPage {}
}

glib::wrapper! {
    pub(crate) struct ImageBuildingPage(ObjectSubclass<imp::ImageBuildingPage>)
        @extends gtk::Widget,
        @implements gtk::Accessible, gtk::Buildable, gtk::ConstraintTarget;
}

impl From<Option<&model::Client>> for ImageBuildingPage {
    fn from(client: Option<&model::Client>) -> Self {
        glib::Object::new(&[("client", &client)]).expect("Failed to build ImageBuildingPage")
    }
}

impl ImageBuildingPage {
