...
mod imp {
    ...
    #[template(file = "back_navigation_controls.ui")]
...
impl BackNavigationControls {
    ...
    fn previous_leaflet_overlay(&self) -> Option<widget::LeafletOverlay> {
        utils::parent_leaflet_overlay(self.upcast_ref())
    }

    fn root_leaflet_overlay(&self) -> widget::LeafletOverlay {
